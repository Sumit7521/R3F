...
export function Playground(props) {
  ...
  return (
    <group {...props} dispose={null}>
      <RigidBody  position={[-20.325,-0.249,-28.42]}  type="fixed" name="gateIn" sensor colliders={false}>
      <mesh
        receiveShadow
        castShadow
      ...
      <RigidBody type="kinematicVelocity" colliders={"trimesh"} ref={swiper} restitution={3} name="swiper">
