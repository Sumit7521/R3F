...
export const Experience = () => {
  ...
  return (
    <>
      <directionalLight position={[-50, 50, 25]} intensity={0.4} castShadow shadow-mapSize-width={1024} shadow-mapSize-height={1024}>
        <PerspectiveCamera 
        ref={shadowCameraRef}
      ...
      <RigidBody colliders={false} position={[3,3,0]} gravityScale={0.2} restitution={1.2 }>
